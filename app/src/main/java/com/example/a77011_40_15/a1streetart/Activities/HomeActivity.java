...
//        Toast.makeText(context, "o", Toast.LENGTH_LONG).show();
    ...
    private File getMediaFile()
    {
        ...
        //TODO récupérer la position GPS à ce moment car la fonction de tag GPS n'est pas forcément activée dans l'app Camera
        Location location = null;
        LatLng thisPicturePosition = new LatLng(location.getLatitude(), location.getLongitude());
